...
// ----------------------------  CONFIG DB  ----------------------------- //
$_config['db']['1']['dbhost'] = '127.6.86.2';
$_config['db']['1']['dbuser'] = 'adminKE6JPsC';
$_config['db']['1']['dbpw'] = 'uNueZggJHFcM';
$_config['db']['1']['dbcharset'] = 'utf8';
$_config['db']['1']['pconnect'] = '0';
$_config['db']['1']['dbname'] = 'www';
$_config['db']['1']['tablepre'] = 'pre_';
$_config['db']['slave'] = '';
$_config['db']['common']['slave_except_table'] = '';

// --------------------------  CONFIG MEMORY  --------------------------- //
$_config['memory']['prefix'] = '1gaTNf_';
$_config['memory']['redis']['server'] = 'pub-redis-18756.us-east-1-3.6.ec2.redislabs.com';
$_config['memory']['redis']['port'] = 18756;
$_config['memory']['redis']['pconnect'] = 1;
$_config['memory']['redis']['timeout'] = '0';
$_config['memory']['redis']['requirepass'] = 'zkVjsDgxlhM55QBQ';
$_config['memory']['redis']['serializer'] = 1;
$_config['memory']['memcache']['server'] = '';
//$_config['memory']['memcache']['server'] = 'pub-memcache-10112.us-east-1-3.6.ec2.redislabs.com';
$_config['memory']['memcache']['port'] = 10112;
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'City_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '9d3038ofDsMmYg5F';
